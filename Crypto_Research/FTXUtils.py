...
class FtxClient:
    ...
    def get_funding_rate(self, start: int = None, end: int = None, pair: str = None):
        return self._get('funding_rates', {'start_time': start, 'end_time': end, 'future': pair})
    
    def get_historical_data(self, resolution: int, start: int = None, end: int = None, symbol: str = None):
        return self._get('markets/{0}/candles?'.format(symbol),{'start_time': start, 'end_time': end, 'resolution': resolution})